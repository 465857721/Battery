...
public class WindowUtil {
    ...
    public void onSettingChanged() {
        String setting = (String) SharedPreferencesUtils.getFromSpfs(context, SpeedActivity.SETTING, SpeedActivity.BOTH);
        if (setting.equals(SpeedActivity.BOTH)) {
            speedView.upText.setVisibility(View.VISIBLE);
            speedView.downText.setVisibility(View.VISIBLE);
        } else if (setting.equals(SpeedActivity.UP)) {
            speedView.upText.setVisibility(View.VISIBLE);
