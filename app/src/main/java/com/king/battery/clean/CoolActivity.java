...
public class CoolActivity extends BaseActivity implements Handler.Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNotificationManager.cancel(1990);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (list.size() > 0) {
                            ...
                            timer.cancel();
                            StatusBarUtil.setColor(CoolActivity.this, ContextCompat.getColor(mContext, R.color.colorPrimary));
